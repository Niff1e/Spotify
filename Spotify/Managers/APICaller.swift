...
final class APICaller {
    ...
    public func getCurrentUserAlbums(completion: @escaping (Result<[LibraryAlbum], Error>) -> Void) {
    ...
    public func getCurrentUserPlaylist(completion: @escaping (Result<[LibraryPlaylist], Error>) -> Void) {
